"""
Реестр инструментов - центральное место для регистрации и доступа к инструментам.

Этот модуль позволяет динамически регистрировать инструменты и получать к ним доступ
из разных частей приложения без явных импортов каждого инструмента.
"""
